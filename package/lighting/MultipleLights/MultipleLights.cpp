...
int main()
{
   ...
   if(glewInit()!= GLEW_OK)
    ...
    // ------------------------------------
    Shader lightingShader("./res/shader/Lighting/MultipleLights/multiple_lights_vs.shader", "./res/shader/Lighting/MultipleLights/multiple_lights_fs.shader");
    Shader lightCubeShader("./res/shader/Lighting/MultipleLights/light_cube_vs.shader", "./res/shader/Lighting/MultipleLights/light_cube_fs.shader");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        */
        ...
        lightingShader.setVec3("spotLight.ambient", 0.5f,0.0f ,0.5f);
